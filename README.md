...
A blazing fast, async-first, undetectable webscraping/web automation framework implemented using the Chrome Devtools Protocol.
...
- descriptive \_\_repr\_\_ for elements, which represent the element as html
